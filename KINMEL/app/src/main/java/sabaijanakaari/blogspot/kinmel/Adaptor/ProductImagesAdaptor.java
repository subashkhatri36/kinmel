...
public class ProductImagesAdaptor extends PagerAdapter {
    ...
    public ProductImagesAdaptor(List<String > productImage) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        Glide.with(container.getContext()).load(productImages.get(position)).apply(new RequestOptions().placeholder(R.drawable.loading)).into(productImage);
